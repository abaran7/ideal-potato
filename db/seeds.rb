...
Product.create!(title: 'The Infernal Devices - Cassandra Clare',
  description: 
    %{<p> 
        Sixteen-year-old Tessa Gray crosses the ocean to find her 
    ...
    dedicated to ridding the world of demons, keep order amidst the chaos. 
        </p>},
...
# . . .
 ...
 Product.create!(title: 'Bookish: Adult Coloring Book - Martha Sweeney',
  description:
    %{<p> 
        Amazon Best-Selling Author Martha Sweeney is pleased to present to you, 
...
Product.create!(title: 'Art Made from Books - Heyenga, Dettmer, Kuhn',
  description: 
    %{<p> 
        Artists around the world have lately been turning to their 
...
Product.create!(title: 'Books Do Furnish a Room - Leslie Geddes-Brown',
  description: 
    %{<p> 
        This guide offers inspirational solutions and practical tips on 
    ...
    room into an alluring and magical place. 
        </p>},
...
Product.create!(title: 'Hippopotamister - John Green',
  description: 
    %{<p> 
        The zoo isn't what it used to be. It's run down, and Hippo hardly 
    ...
    needs is a job where he can be himself. 
        </p>},
...
Product.create!(title: 'The Problem with Forever - Jennifer L. Armentrout',
  description: 
    %{<p> 
        For some people, silence is a weapon. For Mallory “Mouse” Dodge, 
    ...
    hasn’t seen since childhood, on her very first day. 
        </p>},
...
Product.create!(title: 'Anger and Forgiveness - Martha C. Nussbaum',
  description: 
      %{<p> 
        Anger is not just ubiquitous, it is also popular. Many 
